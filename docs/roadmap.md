# Roadmap: Juniauto Category Dominance (Phased Execution)

This document breaks down the [Organic Dominance PRD](prd-organic-dominance.md) into 4 actionable execution phases. Each phase has a clear "Definition of Done" to ensure we build on a solid foundation.
...
## 🛡 Phase 2: The "Trust & Transparency" Layer (Weeks 3-4)
**Goal:** Kill user anxiety and differentiate from "scammers".

### 2.1 Operational Proof (@pm + @dev)
...
**🎯 Checkpoint:** We appear in the "Local Pack" for specific street/neighborhood searches.

---

## 💰 Phase 4: High-Ticket & B2B Moat (Weeks 7+)
**Goal:** Capture high-margin revenue and recurring contracts.

### 4.1 Specialized Funnels (@pm + @copy)
- [ ] **Heavy Duty Page:** "Reboque para Caminhões e Ônibus" (Keywords: Guincho Pesado RJ).
- [ ] **Luxury Transport:** "Transporte de Veículos Premium" (Platform lowering, care focus).

### 4.2 The Partner Ecosystem (@seo)
- [ ] **"Oficinas Parceiras":** SEO content targeting mechanics looking for towing partners.
- [ ] **Corporate Page:** "Frotas e Seguradoras" with compliance details (CNPJ, Invoice capability).

**🎯 Checkpoint:** Inbound leads from mechanics and truck drivers start arriving.

---

## 🔄 Ongoing: The "Dominance Loop"
- **Monthly:** Review Competitor Pricing (@pm).
- **Weekly:** Geo-tagged Photo Uploads to GBP (@seo).
- **Daily:** Speed & Uptime Checks (@dev).
